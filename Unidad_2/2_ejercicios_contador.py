...
respuesta = input("1. ¿En que año estamos? ")
if respuesta == "2021":
    print("Correcto")
...
if respuesta == "7" or respuesta == "siete":
    print("Correcto")
    puntaje = puntaje + 1
else:
    print("Incorrecto")
...
if respuesta == "fútbol" or respuesta == "ciclismo":
    print("Correcto")
    puntaje = puntaje + 1
else:
    print("Incorrecto")

print("Preguntas correctas {}".format(puntaje))
