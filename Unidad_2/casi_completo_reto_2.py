...
# p1=banco, p2=usuario, p3=clave, p4=retiro, p5=saldo_inicial, p6=nuevo_saldo
    ...
    if p3 == 1234:
        ...
        if p4 > 200000: 
            ...
            if p4 <= p5:
                ...
                # Asigna un nuervo valor a la llave "mensaje" en el diccionario informacion
                nuevo_diccionario["mensaje"] = "el valor del costo mas el costo del valor es mayor al saldo"
        else:
            # Si el saldo inicial es menor que el saldo a retirar entonces continua
            if p4 <= p5:
                p6 = p5 - p4
