...
"""print('----->Probando acceso')
print('Monto: ',caso1['5E2U6FI']['transacciones'][0]['monto'])
print(caso1['5E2U6FI']['transacciones'][0][ 'fechaMovimiento'])"""
...
almacenarCasoPruebaJSON(caso2, 'casoSolucion___2.json')
"""
